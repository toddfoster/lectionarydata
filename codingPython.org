...
----------
#+end_example
* WIP: Produce json of hymn titles?
...
----------
#+end_example
* combine hymnals into pretty json
** Test out file format
#+BEGIN_SRC python :python python3 :results output
  import json
...
:
* check on consistency of lff2018.json
#+BEGIN_SRC python :python python3 :results output
  import json
  import unicodedata
  ...
  def analyze(filename):
       ...
       print ("Found " + str(len(lff)) + " records")

       fields = []
       for k in lff[0].keys():
         fields.append(k)
       print ("Found keys: " + ', '.join(fields))

       optional_fields = ["notes", "second_lesson"]
       slugs = []
       has_second = []
       for i in lff:
         for k in i.keys():
           if k not in fields:
             print ("Found new key: " + k)
         for f in fields:
           ...
           if f not in i.keys():
             ...
             print (i)
         if i["slug"] in slugs:
           print ("duplicate slug: " + i["slug"])
         else:
           slugs.append(i["slug"])
         slug = i['slug']
         if slug != strip_accents(slug):
           print ("Accented slug: " + slug)
         if "second_lesson" in i.keys():
           has_second.append(slug)
       print ("Has second lesson: " + str(len(has_second)))
       print ("Has second lessons: " + ' '.join(has_second))

  analyze('../lff2json/lff2018.json')
  analyze('../sharedprayers/data/lff2018.json')
  # analyze('../venite/commonprayer/src/assets/calendar/lff2018.json')
...
Found 271 records
Found keys: mm, dd, title, major_feast, slug, bio, rite1_collect, rite2_collect, first_lesson, psalm, notes, second_lesson, gospel, preface
Has second lesson: 34
Has second lessons: lff2018-holy-name-of-our-lord-jesus-christ lff2018-epiphany lff2018-confession-of-saint-peter-the-apostle lff2018-conversion-of-saint-paul-the-apostle lff2018-presentation lff2018-saint-matthias-the-apostle lff2018-saint-joseph lff2018-annunciation lff2018-saint-mark-the-evangelist lff2018-apostles-saint-philip-and-saint-james lff2018-visitation lff2018-saint-barnabas-the-apostle lff2018-nativity-of-saint-john-the-baptist lff2018-apostles-saint-peter-and-saint-paul lff2018-independence-day lff2018-saint-mary-magdalene lff2018-saint-james-the-apostle lff2018-transfiguration lff2018-saint-mary-the-virgin lff2018-saint-bartholomew-the-apostle lff2018-holy-cross-day lff2018-saint-matthew lff2018-saint-michael-and-all-angels lff2018-saint-luke-the-evangelist lff2018-saint-james-of-jerusalem lff2018-saint-simon-and-saint-jude lff2018-all-saints lff2018-all-souls lff2018-saint-andrew-the-apostle lff2018-saint-thomas-the-apostle lff2018-nativity-of-our-lord-jesus-christ lff2018-saint-stephen lff2018-saint-john lff2018-holy-innocents
--------------------
analyze: ../sharedprayers/data/lff2018.json
...
Has second lessons: lff2018-holy-name-of-our-lord-jesus-christ lff2018-epiphany lff2018-confession-of-saint-peter-the-apostle lff2018-conversion-of-saint-paul-the-apostle lff2018-presentation lff2018-saint-matthias-the-apostle lff2018-saint-joseph lff2018-annunciation lff2018-saint-mark-the-evangelist lff2018-apostles-saint-philip-and-saint-james lff2018-visitation lff2018-saint-barnabas-the-apostle lff2018-nativity-of-saint-john-the-baptist lff2018-apostles-saint-peter-and-saint-paul lff2018-independence-day lff2018-saint-mary-magdalene lff2018-saint-james-the-apostle lff2018-transfiguration lff2018-saint-mary-the-virgin lff2018-saint-bartholomew-the-apostle lff2018-holy-cross-day lff2018-saint-matthew lff2018-saint-michael-and-all-angels lff2018-saint-luke-the-evangelist lff2018-saint-james-of-jerusalem lff2018-saint-simon-and-saint-jude lff2018-all-saints lff2018-all-souls lff2018-saint-andrew-the-apostle lff2018-saint-thomas-the-apostle lff2018-nativity-of-our-lord-jesus-christ lff2018-saint-stephen lff2018-saint-john lff2018-holy-innocents
#+end_example
* extract lff2018.json into spreadsheet
#+BEGIN_SRC python :python python3 :results output
  import json
  ...
  def analyze(filename):
      ...
      # 2022 date; Fixed Date; Movable Date; Order ; Code ;
      # 2022 date: =DATE(A$1-1, 12, 21)

      # keys: mm, dd, title, major_feast, slug, bio, rite1_collect, rite2_collect, first_lesson, psalm, notes, second_lesson, gospel, preface

      print ("Found " + str(len(lff)) + " records")

      with open ("output/lff2018keys.csv", "w") as t:
          count = 801
          advent4 = 'DATE($A$1,12,25) + 8 - WEEKDAY(DATE($A$1,12,25)) - 7 * 5'
          for i in lff:
              month = str(int(i["mm"]))
              day = str(int(i["dd"]))
              monthday = month + ',' +  day
              result = '"=IF(DATE($A$1,' + monthday + ')>=' + advent4
              result += ',  DATE($A$1-1,' + monthday + '), DATE($A$1,' + monthday + '))"'
              result += ', "' + months[(int (i["mm"])-1)] + ' ' + str(int(i["dd"])) + '", ""'
              result += ', "' + str(count) + '", "' + i['slug'] + '"' + '\n'
              count += 1
              t.write(result)
