...
#+BEGIN_SRC python :python python3 :results output
  ...
  def writeliturgy(day, when, year):
      print ("Generating liturgy for " + day + ": " + str(when))
...
#+RESULTS:
: Generating liturgy for proper-27: 2021-11-07
: Generating liturgy for proper-28: 2021-11-14
: Generating liturgy for proper-29-christ-the-king: 2021-11-21
: Generating liturgy for thanksgiving-day: 2021-11-25
