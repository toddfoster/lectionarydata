...
{'whentype': 'year', 'when': 'A', 'day': 'proper-11', 'lectionary': 'rclsundayTrack1', 'type': 'gospel', 'citation': 'Matthew 13:24-30, 13:36-43'}
...
{'whentype': 'year', 'when': 'A', 'day': 'proper-11', 'lectionary': 'rclsunday', 'type': 'gospel', 'citation': 'Matthew 13:24-30, 13:36-43'}
#+end_example
...
#+BEGIN_SRC python :python python3 :results output
  ...
  rcl = loadlectionary('lectionary/rcl1.json')
  rcl += loadlectionary('lectionary/rcl2.json')
...
** Days converted to BCP standard
