          ...
          for i in range(len(citations)):
              ...
              with open (destmark + filename + ".md", "w") as t:
                  ...
                  for e in d.descendants:
                      ...
                      line = ""
                      # TODO: Discard initCap
                      # TODO: Preserve <br> within paragraph
                      # TODO: lordSmallCaps tags to LORD or GOD
                      # TODO: Indent for poetryText, psalmText, poetryIndent, lessonIndent; not for lessonText
                      if e.has_attr('class'):
                          ...
                          if newClass != lastClass:
                              if lastClass:
                                   line = "\n"
                              lastClass = newClass
                          if "poetry" in newClass or "psalm" in newClass or "Indent" in newClass:
                              line = line + "> "
                      line = line + e.getText() + "\n"
                      t.write(line)
...
: Unique Refs count = 928
: Tags in div's: {'p': 5307, 'poetryText': 1337, 'span': 2649, 'initCap': 918, 'br': 4590, 'lordSmallCaps': 1707, 'psalmText': 2122, 'lessonText': 1478, 'poetryIndent': 283, 'lessonIndent': 16}
